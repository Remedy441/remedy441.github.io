...
function initialiseScene(){
    ...
    PIEstartButton.addEventListener('click', function(){
        totaldistance.material.materials[0].color.setHex(0xffffff);
        wrong.visible=false;
...
function loadExperimentElements(){
    ...
    //finishline
    tex=new THREE.ImageUtils.loadTexture("checkerboard.jpg", function(){
        PIErender();
    });
    ...
    loader.load("totaldistance.json", function(geometry, materials) {
