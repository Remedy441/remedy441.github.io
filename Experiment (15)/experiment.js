...
/*
	var points = [];
	for ( var i = 0; i < 4; i ++ ) {
		points.push( new THREE.Vector2( Math.sin( i * 0.9 ) * 16 , ( i - 5 ) * 3 ) );
	}	
...
/*
var lampBase = new THREE.Mesh(new THREE.CylinderGeometry(3,4,2,32),new THREE.MeshPhongMaterial({color:"black"}));
lampBase.position.set(14,-8,0);
PIEaddElement(lampBase);


var lampMid = new THREE.Mesh(new THREE.CylinderGeometry(3,3,10,32),new THREE.MeshPhongMaterial({color:"yellow",transparent:true,opacity:0.8,shininess:500}));
lampMid.position.set(14,-2,0);
PIEaddElement(lampMid);


var lampMid = new THREE.Mesh(new THREE.CylinderGeometry(3,3,2,32),new THREE.MeshPhongMaterial({color:"black"}));
lampMid.position.set(14,4,0);
PIEaddElement(lampMid);
*/
