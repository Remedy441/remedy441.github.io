...
{
    helpContent="";
    helpContent = helpContent + "<h2>The electric generator – how does it work experiment help</h2>";
    helpContent = helpContent + "<h3>About the experiment</h3>";
    helpContent = helpContent + "<p>The experiment shows basic schematic of an electric generator</p>";
...
{
    infoContent =  "";
    infoContent = infoContent + "<h2>The electric generator – how does it work concepts</h2>";
...
{
	PIEsetExperimentTitle("The electric generator – how does it work");
...
PIEadjustCamera(-180,30,130);
PIEturnCamera(50,25,20);
