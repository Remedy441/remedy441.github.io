...
function addButtonToControls1(text) {
    var button=document.createElement("input");
    button.setAttribute("type","checkbox");
    button.setAttribute("id", text);
    button.setAttribute("class", "objects");
    ...
    // document.getElementById("object_selection_list").appendChild(para);
    document.getElementsByTagName("form")[1].appendChild(para);
}
...
function initialiseControls() {
    ...
    list1.setAttribute("id","object_selection_list1");
    ...
    document.getElementById("object_selection_list1").appendChild(form1);
    addButtonToControls("Ball");
    addButtonToControls("Cube");
    addButtonToControls("Teapot");
    addButtonToControls("Arrow");
    addButtonToControls1("Shoe");
    addButtonToControls1("Cone");
    addButtonToControls1("Pillar");
