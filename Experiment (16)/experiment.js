...
document.getElementById("pause").style.visibility="hidden";
   ...
   /*
    ...
    if(t>0 && t<1500){
   	    ...
   	    wire1.material.color.setStyle("blue");
	    wire2.material.color.setStyle("blue");
	    lampBulb.material.color.setStyle("white");
	 	lampBulb.material.transparent = true;
    ...
    else if(t>=1500 && t<2200){
    	setOff();
   	}
    else if(t>=2200 && t<5000){
    	saltbottle.visible = true;
     	saltbottle.rotation.z = Math.PI*0.07*(t-2000)/300;

    }

    else if(t>=5800 && t<9000){
		lampBulb.material.color.setStyle("yellow");
		wire1.material.color.setStyle("yellow");
	    wire2.material.color.setStyle("yellow");
	    
	    wire1.material.transparent = true;
	    wire2.material.transparent = true;
		lampBulb.material.transparent = true;
   	 	
		wire1.material.opacity = (t+5000)/14000;
    	wire2.material.opacity = (t+5000)/14000;
    	lampBulb.material.opacity = (t+5000)/14000;
    	
	    

	    //saltbottle.rotation.z = -Math.PI * 0.05*(9000-t)/9000;
    }
    else if(t>=9000){
    	setOn();
    ...
    if(t>=7000 && t<=9000){
    	saltbottle.rotation.z = Math.PI*1*(9000-t)/3000;
    }
	*/
//	document.getElementById("stop").addEventListener("click",stopTheProcess);
