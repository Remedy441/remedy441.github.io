...
var intersects; 
var name1 =["Mercury","Venus","Earth","Mars","Jupiter","Saturn","Uranus","Neptune","None"];
var distance=["0.39 AU","0.723 AU","1 AU","1.524 AU","5.203 AU","9.6 AU","19.18 AU","30.06 AU","None"];
var time=["88 days","225 days","365 days","687 days","12 years","29 years","84 years","165 years","None"];
function onMouseDown(event){
	...
	raycaster.setFromCamera( mouse, PIEcamera );	
		...
		displayPlanet(name1[p],distance[p],time[p]);
		inputPlanet(name1[p],distance[p],time[p]);	
