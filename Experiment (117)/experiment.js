...
/*******************HTML ELEMENTS ARE ADDED***************/
	...
	div = document.createElement("div");													/*div for show ruler option*/
		div.setAttribute('class','label');
		div.setAttribute('id', 'showRuler');
		div.setAttribute('onclick','showRuler()');
		div.innerHTML= "Show Ruler on Next Side";
		document.body.appendChild(div);
	...
	function exercise()
	{
		...
		document.getElementById("showRuler").style.visibility="visible";
	...
	function showRuler()
	{
		...
		if(frameCount==0)
		{
			if(track==1)
			{
				ruler.position.set(centerX-20,centerY-14,0);
				ruler.visible=true;
			}
			if(track==2)
			{
				ruler.rotateZ(Math.PI/2.35);
				ruler.position.set(centerX-25,centerY-4,0);
			}
			if(track==3)
			{
				ruler.position.set(centerX-20,centerY+7,0);
			}
			if(track==4)
			{
				ruler.rotateZ(-Math.PI/2.35);
				ruler.position.set(centerX-15,centerY-4,0);
				track=0;
			}
		}
		else if(frameCount==1)
		{
			if(track==1)
			{
				ruler.position.set(centerX-20,centerY-9,0);
				ruler.visible=true;
			}
			if(track==2)
			{
				ruler.rotateZ(Math.PI/2);
				ruler.position.set(centerX-28,centerY-4,0);
			}
			if(track==3)
			{
				ruler.position.set(centerX-20,centerY+2,0);
			}
			if(track==4)
			{
				ruler.rotateZ(-Math.PI/1.55);
				ruler.position.set(centerX-14,centerY-4,0);
				track=0;
			}
		}
		else if(frameCount==2)
		{
			if(track==1)
			{
				ruler.position.set(centerX-20,centerY-11,0);
				ruler.visible=true;
			}
			if(track==2)
			{
				ruler.rotateZ(Math.PI/1.65);
				ruler.position.set(centerX-22,centerY-4,0);
			}
			if(track==3)
			{
				ruler.position.set(centerX-15,centerY+4,0);
			...
			if(track==4)
			{
				ruler.rotateZ(-Math.PI/1.45);
				ruler.position.set(centerX-12,centerY-4,0);
				track=0;
			}
		}
	}
 ...
 */
	...
	function loadExperimentElements()
	    ...
	    geometry = new THREE.PlaneGeometry( 120  , 60, 32 );
	  	...
	  	material = new THREE.MeshBasicMaterial( {color: 0x88ade8} );
			...
			geometry = new THREE.PlaneGeometry(35, 5,0);
	...
	function resetExperiment()
	{
	  initialiseOtherVariables();
		...
		document.getElementById("showRuler").style.visibility="hidden";
