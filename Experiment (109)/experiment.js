...
var shape = new THREE.Shape(lens.getSpacedPoints(100));
var lensgeometry = new THREE.ShapeGeometry( shape );
...
function initialiseControlVariables()
{
    ...
    //r_default=ri;
    /* Slider Limits */
    Xmin=3;   /* X Position Slider Minimum Value */
    Xmax=40;  /* X Position Slider Maximum Value */
...
{
    helpContent="";
    helpContent = helpContent + "<h2>Refraction at a convex lens help</h2>";
    helpContent = helpContent + "<h3>About the experiment</h3>";
    helpContent = helpContent + "<p>The experiment shows a convex lens with refraction of rays</p>";
...
{
    infoContent =  "";
    infoContent = infoContent + "<h2>Refraction at a convex lens experiment concepts</h2>";
    infoContent = infoContent + "<h3>About the experiment</h3>";
    infoContent = infoContent + "<p>The experiment shows a convex lens with refraction of rays.</p>";
    ...
    infoContent = infoContent + "<h3>Refraction through convex lens</h3>";
...
function loadExperimentElements()
{
    ...
    PIEsetExperimentTitle("Refraction at a convex lens");
...
geometry.vertices.push(new THREE.Vector3(z,height - height*z/f, 0)); 
z += ri;
/*
