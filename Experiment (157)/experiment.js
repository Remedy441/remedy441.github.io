...
{
    /* Labels */
    angleHammer="Angle of Release of Pendulum Bob";                  /* X Position Slider Label */
    wireLength=1.5;
    pinTopX=myCenterX;
    pinTopY=1.5*1.5;
    aHdefault=90;
    ...
    aHmax=90;
    massballCaption="mass of Ball on floor";
    massball=10;
    massballdefault=10;
    masshammerCaption="Mass of Pendulum Bob";
    masshammer=20;
    ...
    masshammerstep=1;       
    myBallVX=0;
    myBallVXCaption="Velocity of Ball on floor<br>"
}
...
var texture;
    ...
    PIEsetExperimentTitle("Inertia and mass");
...
// Create Floor
    ...
    PIEaddElement(Floor);
//Create the support
    support1=new THREE.Mesh(new THREE.BoxGeometry(.5*myBallRadius,mySceneW,.5),material);
    support1.position.set(1,1,1);
    PIEaddElement(support1);
    support2=new THREE.Mesh(new THREE.BoxGeometry(.5*myBallRadius,mySceneW,.5),material);
    support2.position.set(1,1,1);
    PIEaddElement(support2);
    support3=new THREE.Mesh(new THREE.BoxGeometry(.5*myBallRadius,mySceneW,.3),material);
    support3.position.set(1,1,1);
    PIEaddElement(support3);
...
function resetExperiment()
{
    ...
    support1.position.set(0-.035,-1,myHammerZ);
    support2.position.set(mySceneW+.03,-1,myHammerZ);
    support3.position.set(mySceneW/2,4.24,myHammerZ);
...
setTimeout(function(){
    ...
    PIEscene.children[6].intensity=0.2;
        PIErender();
         for(i=0;i<2;i++){
        document.getElementsByClassName('main')[i].style.width="500px";
    }
