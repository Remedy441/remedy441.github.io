...
else if(itheta==45)
{
    ...
    myBallX = newpos.x;
    if (w1x < 0.2) { e=c;p=d;myBallX = 0.25+0.09; w1x=0.2; w1y=1.557+(1.32-0.2)*Math.tan(rad); w2x=0.2;w2y=1.557+(1.32-0.2)*Math.tan(rad);w3x=0.2;w3y=1.557+(1.32-0.2)*Math.tan(rad);w4x=0.2;w4y=1.557+(1.32-0.2)*Math.tan(rad); myBallY =1.557+(1.32-0.2)*Math.tan(rad)-0.027;block.lookAt(new THREE.Vector3(-0.35,Math.tan(rad),0.2));PIErender();}
	
	
    else if (newpos.x >0.1&&newpos.x<1.18+b) { w1y=1.557+(1.32-w1x)*Math.tan(rad);w2y=1.557+(1.32-w2x)*Math.tan(rad);w3y=1.557+(1.32-w3x)*Math.tan(rad);w4y=1.557+(1.32-w4x)*Math.tan(rad);myBallY =1.557+(1.32+b-y)*Math.tan(rad)+b;block.lookAt(new THREE.Vector3(-0.35,Math.tan(rad),0.2));PIErender();  }
	else if(newpos.x >1.18+b){e=c+0.03;myBallY=1.557+b;myBallX=1.18+b;w1x=1.18+b,w2x=1.18+b;w3x=1.18+b;w4x=1.18+b;w1y=1.557;w2y=1.557;w3y=1.557;w4y=1.557;  block.lookAt(new THREE.Vector3(-1.0,100.0,0));  }
...
*/
 ...
 myBallZ = newpos.z;
    block.position.set(myBallX, myBallY-0.07, myBallZ);
	wheel1.position.set(w1x+0.04, w1y-0.09, w1z);
	wheel2.position.set(w2x+0.04, w2y-0.09, w2z);
	wheel3.position.set(w3x+e+0.04, w3y-p-0.09, w3z);
	wheel4.position.set(w4x+e+0.04, w4y-p-0.09, w4z);
	myBall.position.set(myBallX, myBallY-0.07, myBallZ);
...
else if(itheta==30)
{
    ...
    myBallX = newpos.x;
    if (w1x < 0) { e=c;p=d;myBallX = 0.05+0.09; w1x=0; w1y=1.557+(1.32-0)*Math.tan(rad); w2x=0;w2y=1.557+(1.32-0)*Math.tan(rad);w3x=0;w3y=1.557+(1.32-0)*Math.tan(rad);w4x=0;w4y=1.557+(1.32-0)*Math.tan(rad); myBallY =1.557+(1.32-0)*Math.tan(rad)-0.027;block.lookAt(new THREE.Vector3(-0.45,Math.tan(rad),0.2));PIErender();}
	
	
    else if (newpos.x >0.1&&newpos.x<1.18+b) { w1y=1.557+(1.32-w1x)*Math.tan(rad);w2y=1.557+(1.32-w2x)*Math.tan(rad);w3y=1.557+(1.32-w3x)*Math.tan(rad);w4y=1.557+(1.32-w4x)*Math.tan(rad);myBallY =1.557+(1.32+b-y)*Math.tan(rad)+b;block.lookAt(new THREE.Vector3(-0.45,Math.tan(rad),0.2));PIErender();  }
	else if(newpos.x >1.18+b){e=c+0.03;myBallY=1.557+b;myBallX=1.18+b;w1x=1.18+b,w2x=1.18+b;w3x=1.18+b;w4x=1.18+b;w1y=1.557;w2y=1.557;w3y=1.557;w4y=1.557;  block.lookAt(new THREE.Vector3(-1.0,100.0,0));  }
...
*/
 ...
 myBallZ = newpos.z;
    block.position.set(myBallX, myBallY-0.07, myBallZ);
	wheel1.position.set(w1x+0.09, w1y-0.09, w1z);
	wheel2.position.set(w2x+0.09, w2y-0.09, w2z);
	wheel3.position.set(w3x+e+0.09, w3y-p-0.09, w3z);
	wheel4.position.set(w4x+e+0.09, w4y-p-0.09, w4z);
	myBall.position.set(myBallX, myBallY, myBallZ);
...
function rotateAroundWorldAxis(object, axis, radians) {
 ...
 {
	 var x=nradius;
	 nradius=(mySceneW/50.0)-0.02+massval*0.01;
	 myBallRadius=x;
	 
	 b=nradius-(mySceneW/50.0);
...
{
	PIErefreshButton.style.visibility = "hidden";
    massval=newValue;
	rad();
}
...
function handlec()
{
	   ...
	   PIErefreshButton.style.visibility = "hidden";
		   surface="cloth";
		   c=0.5;
		   PIEchangeInputText("SURFACE","CLOTH");
		   PIEscene.remove(myFloor);
		geometry = new THREE.BoxGeometry( 8.1, 0.2, 7.0);
    material = new THREE.MeshLambertMaterial( {color: 0x00ff00} );
    myFloor  = new THREE.Mesh( geometry, material );

	myFloor.position.set(3.1,bottomB - (wallThickness / 2)+1.5, 0.0); 
...
function handleg()
{
	...
	coeffofrictionvalue=0.8;
	surface="glass";
	PIEchangeInputText("SURFACE","GLASS");
	 PIEscene.remove(myFloor);
		geometry = new THREE.BoxGeometry( 8.1, 0.12, 7.0);
    material = new THREE.MeshLambertMaterial( {color: 0xC0C0C0} );
    myFloor  = new THREE.Mesh( geometry, material );

	myFloor.position.set(3.1,bottomB - (wallThickness / 2)+1.52, 0.0); 
	//myFloor.position.set(myBallX+3.1,myBallY+7.0, myBallZ+2.0);   
   //myFloor.lookAt(new THREE.Vector3(7.0,5.8,2));
...
function handlew()
{
	...
	PIErefreshButton.style.visibility = "hidden";
	coeffofrictionvalue=0.3;
	surface="wood";
	PIEchangeInputText("SURFACE","WOOD");
	
	  PIEscene.remove(myFloor);
		geometry = new THREE.BoxGeometry( 8.1, 0.3, 7.0);
    material = new THREE.MeshLambertMaterial( {color: 0x663300} );
    myFloor  = new THREE.Mesh( geometry, material );

	myFloor.position.set(3.1,bottomB - (wallThickness / 2)+1.43, 0.0); 
	//myFloor.position.set(myBallX+3.1,myBallY+7.0, myBallZ+2.0);   
   //myFloor.lookAt(new THREE.Vector3(7.0,5.8,2));
...
// PIEscene.remove(c);
  ...
  {   
   geometry = new THREE.BoxGeometry( 1.0, 1.7, 0.2 );
    ...
    iplane.position.set(0.5,2.0, 0.199);
  
    PIEaddElement(iplane);
	
	
	
	geometry = new THREE.BoxGeometry( 1.0,1.05, 0.3);
	 material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    cx = new THREE.Mesh( geometry, material );
	cx.lookAt(new THREE.Vector3(1.0,0,0));
    cx.position.set(-0.03,2.0, 0.205);

    PIEaddElement(cx);
	
	
	
	geometry = new THREE.BoxGeometry( 1.0, 0.5, 0.4 );
	 material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    dx = new THREE.Mesh( geometry, material );
	dx.lookAt(new THREE.Vector3(1.0,0,0));
    dx.position.set(0.20,2.0, 0.205);
  
    PIEaddElement(dx);
    
	
	geometry = new THREE.BoxGeometry( 1.0, 0.4, 0.3 );
	 material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    ex = new THREE.Mesh( geometry, material );
	ex.lookAt(new THREE.Vector3(1.0,0,0));
    ex.position.set(0.47,1.8, 0.205);
 
    PIEaddElement(ex);
	
	
   geometry = new THREE.BoxGeometry( 1.0, 0.5, 0.8 );
	 material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    fx = new THREE.Mesh( geometry, material );
	fx.lookAt(new THREE.Vector3(1.0,0,0));
    fx.position.set(0.5,1.5, 0.205);
 
    PIEaddElement(fx);
	
	 
	rad= itheta * Math.PI/180;
  var rad1=itheta1 * Math.PI/180;
	var c1=0.2*Math.cos(rad);
    var d1=0.2*Math.sin(rad);	 
     myBall.position.set(1.12-Math.cos(rad)+0.09, 1.6+Math.sin(rad)-0.02, 0.2);
   wheel1.position.set(1.12-Math.cos(rad), 1.6+Math.sin(rad), 0.2);
   wheel2.position.set(1.12-Math.cos(rad), 1.6+Math.sin(rad), 0.6);
   wheel3.position.set(1.12-Math.cos(rad)+c1, 1.6+Math.sin(rad)-d1, 0.2);
   wheel4.position.set(1.12-Math.cos(rad)+c1, 1.6+Math.sin(rad)-d1, 0.6);
    block.lookAt(new THREE.Vector3(-1.3,Math.tan(rad1),0.2));
	//  wheel4.position.set(1.32, 1.557, 0.6);
	  //wheel4.position.set(1.12, 1.657, 0.6);
   block.position.set(0.67-1.7*c1+0.05,2.62-1.7*d1-0.1, 0.199);
   ...
   else if(newValue==30)
   {
    ...
    iplane.position.set(0.45,1.8, 0.199);
  
    PIEaddElement(iplane);
	
	
	
	geometry = new THREE.BoxGeometry( 1.0,0.9, 0.4);
	 material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    cx = new THREE.Mesh( geometry, material );
	cx.lookAt(new THREE.Vector3(1.0,0,0));
    cx.position.set(-0.18,1.7, 0.205);

    PIEaddElement(cx);
	
	
	
	geometry = new THREE.BoxGeometry( 1.0, 0.5, 0.3 );
	 material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    dx = new THREE.Mesh( geometry, material );
	dx.lookAt(new THREE.Vector3(1.0,0,0));
    dx.position.set(0.10,1.7, 0.205);
  
   PIEaddElement(dx);
    
	
	geometry = new THREE.BoxGeometry( 1.0, 0.25, 0.3 );
	 material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    ex = new THREE.Mesh( geometry, material );
	ex.lookAt(new THREE.Vector3(1.0,0,0));
    ex.position.set(0.27,1.8, 0.205);
 
    PIEaddElement(ex);
	
	
   geometry = new THREE.BoxGeometry( 1.0, 0.45, 0.8 );
	 material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    fx = new THREE.Mesh( geometry, material );
	fx.lookAt(new THREE.Vector3(1.0,0,0));
    fx.position.set(0.37,1.5, 0.205);
	...
	var c1=0.2*Math.cos(rad);
    var d1=0.2*Math.sin(rad);	 
    myBall.position.set(1.11-Math.cos(rad)+0.09, 1.7+Math.sin(rad)-0.02, 0.2);
    wheel1.position.set(1.12-Math.cos(rad), 1.6+Math.sin(rad), 0.2);
    wheel2.position.set(1.12-Math.cos(rad), 1.6+Math.sin(rad), 0.6);
    wheel3.position.set(1.12-Math.cos(rad)+c1, 1.6+Math.sin(rad)-d1, 0.2);
    wheel4.position.set(1.12-Math.cos(rad)+c1, 1.6+Math.sin(rad)-d1, 0.6);
	//block.lookAt(new THREE.Vector3(1.5,0,0.2));
     block.lookAt(new THREE.Vector3(0,Math.tan(rad1),0.2));
	//  wheel4.position.set(1.32, 1.557, 0.6);
	  //wheel4.position.set(1.12, 1.657, 0.6);
    block.position.set(0.67-2.3*c1+0.05,2.62-4.0*d1-0.11, 0.199);
   ...
   else if(newValue==60)
   {
    ...
    cx = new THREE.Mesh( geometry, material );
	cx.lookAt(new THREE.Vector3(1.0,0,0));
    cx.position.set(0.28,2.4, 0.605);
  //  myRight.receiveShadow = false;
    ...
    dx = new THREE.Mesh( geometry, material );
	dx.lookAt(new THREE.Vector3(1.0,0,0));
    dx.position.set(0.38,2.0, 0.205);
  //  myRight.receiveShadow = false;
    PIEaddElement(dx);
    ...
    ex = new THREE.Mesh( geometry, material );
	ex.lookAt(new THREE.Vector3(1.0,0,0));
    ex.position.set(0.63,1.8, 0.205);
  //  myRight.receiveShadow = false;
    PIEaddElement(ex);
   ...
   geometry = new THREE.BoxGeometry( 1.0, 0.7, 0.5 );
    ...
    fx = new THREE.Mesh( geometry, material );
	fx.lookAt(new THREE.Vector3(1.0,0,0));
    fx.position.set(0.78,1.5, 0.205);
  //  myRight.receiveShadow = false;
    PIEaddElement(fx);
...
var c=0.2*Math.cos(rad1);
    var d=0.2*Math.sin(rad1);
           myBall.position.set(1.12-Math.cos(rad1)+b+0.09, 1.8+Math.sin(rad1)-0.02, 0.2);
   wheel1.position.set(1.12-Math.cos(rad1)+b, 1.8+Math.sin(rad1), 0.2);
   wheel2.position.set(1.12-Math.cos(rad1)+b, 1.8+Math.sin(rad1), 0.6);
   wheel3.position.set(1.12-Math.cos(rad1)+b+c, 1.8+Math.sin(rad1)-d, 0.2);
   wheel4.position.set(1.12-Math.cos(rad1)+b+c, 1.8+Math.sin(rad1)-d, 0.6);
   //block.lookAt(new THREE.Vector3(-0.7,Math.tan(rad1),0.2));
     block.lookAt(new THREE.Vector3(-2.3,Math.tan(rad),0.2));
...
function initialiseControls()
{
    ...
    /* Create Input Panel */
    PIEaddInputSlider(mass, massdefault, handleX, 2.0, 6.0, 0.5);
...
PIEaddInputText("SURFACE", "CLOTH" );

//PIEaddInputCheckbox(mass,"sad",handlew);
//PIEaddInputCheckbox(mass,"cloth",handlec);
//PIEchangeInputCheckbox(mass,"Ram");
	...
	PIEaddDisplayText(PosX,pe);
	PIEaddDisplayText(PosY,ke);
	PIEaddDisplayText(VelX,energy);
...
var PIErefreshButton;

function PIErefreshExperiment()
{
		var rad= itheta1 * Math.PI/180;
	var rad1=itheta * Math.PI/180;
//PIEstopAnimation();
...
PIEstopButton.style.visibility = "visible";
...
//	alert();
   ...
   wheel3.position.set(1.12-Math.cos(rad)+c1, 1.6+Math.sin(rad)-d1, 0.2);
   wheel4.position.set(1.12-Math.cos(rad)+c1, 1.6+Math.sin(rad)-d1, 0.6);
    block.lookAt(new THREE.Vector3(-2.50,Math.tan(rad1)-0.3,0.2));
	//  wheel4.position.set(1.32, 1.557, 0.6);
	  //wheel4.position.set(1.12, 1.657, 0.6);
   block.position.set(0.67-1.7*c1+0.05,2.62-1.7*d1-0.1, 0.199);
    ...
    wheel3.position.set(1.12-Math.cos(rad)+c1, 1.6+Math.sin(rad)-d1, 0.2);
    wheel4.position.set(1.12-Math.cos(rad)+c1, 1.6+Math.sin(rad)-d1, 0.6);
     block.lookAt(new THREE.Vector3(-2.1,Math.tan(rad1)-6.0,0.2));
	//  wheel4.position.set(1.32, 1.557, 0.6);
	  //wheel4.position.set(1.12, 1.657, 0.6);
    block.position.set(0.67-2.3*c1+0.05,2.62-4.0*d1-0.11, 0.199);
...
PIErefreshButton   = PIEaddButton("refresh");
       PIErefreshButton.style.visibility = "hidden";
    PIErefreshButton.style.display = "inline";
    PIErefreshButton.addEventListener('click', PIErefreshExperiment);
...
//PIEaddElement(triangleMesh); 
    geometry = new THREE.BoxGeometry( 7.5, 0.2, 7.0);
    material = new THREE.MeshLambertMaterial( {color: 0x54ff9f} );
    myFloor  = new THREE.Mesh( geometry, material );
myFloor.position.set(myBallX+2.7,myBallY+7.0, myBallZ+2.0);   
   myFloor.lookAt(new THREE.Vector3(7.0,5.8,2));
...
myRight.position.set(rightB-3.5, myCenterY, 0.2);
    ...
    PIEaddElement(myBack);
	 ...
	 var scale;
	  geometry = new THREE.BoxGeometry( 6.2, 0.4, 1.5);
    material = new THREE.MeshLambertMaterial( {color: 0xaaaaaaa} );
    scale = new THREE.Mesh( geometry, material );
    scale.position.set(4.02, 1.7, -1.0);
   // myBack.castShadow = false;
    PIEaddElement(scale);

	
    var e;
	geometry = new THREE.BoxGeometry( 0.005, 0.3, 0.01);
    material = new THREE.MeshLambertMaterial( {color: 0x000000} );
    e = new THREE.Mesh( geometry, material );
    e.position.set(1.25, 1.6, 0);
   // myBack.castShadow = false;
    PIEaddElement(e);
var c=0.1;
	...
	for(var i=1;i<=50;i++)
	{
		...
		geometry = new THREE.BoxGeometry( 0.005, 0.3, 0.01);
    material = new THREE.MeshLambertMaterial( {color: 0x000000} );
    con[i]= new THREE.Mesh( geometry, material );
    con[i].position.set(1.25+c, 1.6, 0);
		}
		else
		{
			
			geometry = new THREE.BoxGeometry( 0.005, 0.2, 0.01);
    material = new THREE.MeshLambertMaterial( {color: 0x000000} );
    con[i]= new THREE.Mesh( geometry, material );
    con[i].position.set(1.25+c, 1.5, 0);
...
itheta1=30;
 ...
 coeffofrictionvalue=0.5;
  ...
  PIEscene.remove(fx);
    ...
    material = new THREE.MeshLambertMaterial( {color: 0xA9A9A9} );
    iplane = new THREE.Mesh( geometry, material );
	iplane.lookAt(new THREE.Vector3(1.0,Math.tan(rad1),0));
	//iplane.lookAt(new THREE.Vector3(1.0,,0));
    iplane.position.set(0.7,2.2, 0.199);
  //  myRight.receiveShadow = false;
    PIEaddElement(iplane);
  ...
  //  myRight.receiveShadow = false;
   ...
   //        myBall.position.set(rightB-1.20,1.95 , 0.0);
	...
	myFloor.position.set(myBallX+2.7,bottomB - (wallThickness / 2)+1.5, 0.0); 
...
//	y1=x*Math.cos(rad);
	...
	//block.rotatex(ang);
	//	var xAxis = new THREE.Vector3(1,angle,0);
//rotateAroundWorldAxis(block, xAxis, Math.PI / 180);
		//PIErender();
		//alert(z1);
	...
	else if(phaset==2)
	{
		...
		if(c<=0)
		{
			...
			boundaryT=-1.0*(myBallVY)/(coeffofrictionvalue*myBallAY);
			//alert(boundaryT);
			x=boundaryT*myBallVY+0.5*coeffofrictionvalue*myBallAY*boundaryT*boundaryT;
			phaset=0;
			phaseo=0;
	...
	else if(phasetr==1)
	{
		...
		y=0;
		//PIErefreshButton.style.display = "inline";
		//PIErefreshButton.style.visibility = "visible";
		
	//	PIErefreshButton.style.display = "inline";
		//PIErefreshButton.style.visibility = "visible";
		//PIEstartButton.style.visibility = "visible";
		//PIEstartButton.style.display="inline";
		
//	  PIEstopButton.style.visibility = "hidden";
	...
	{
		var x=c;
	//block.lookAt(new THREE.Vector3(-1.1,100,0));	
		blocky=1.615;
		myBallY=1.667;
...
//	var z=0;
  ...
  PIEchangeDisplayText(dist,z);
   PIEchangeDisplayText(coeffofriction,coeffofrictionvalue);
	...
	PIEchangeDisplayText(PosY,massval*myBallAY*(1.615-blocky));
	PIEchangeDisplayText(VelX,0.5*massval*myBallVY*myBallVY+massval*myBallAY*(blocky-1.615));
	
	 /*PosX="Kinetic energy of Ball";                
    PosY="Potential energy of Ball";                 
    VelX="Total energy of Ball";*/
